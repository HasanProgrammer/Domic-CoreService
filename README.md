...
| **ServiceDiscovery** | برخورداری از ابزارهای مناسب برای دریافت و واکشی اطلاعات سرویس ها مبتنی بر سرویس `StateTracker` و بررسی سلامت سرویس ها ( `HealthCheck` ) براساس چرخه زمان بندی مشخص                                                                                    |
