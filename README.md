...
تا به اینجای کار ، ما به بررسی نحوه مدیریت `Event` در بستر `MessageBroker` پرداخیتم ، حال برای پردازش `Message` نیز تمام مراحل فوق صادق می باشند و تنها در رابط مدیریت کننده `Message` تفاوت وجود دارد .
