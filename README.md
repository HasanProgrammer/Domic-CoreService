...
🔥 **توجه** : **دقت داشته باشید که `Command` و `Query` های مربوطه می بایست در لایه `UseCase` تعریف شوند**
...
🔥 **توجه** : **دقت داشته باشید که منطق `Cache` های نوشته شده می بایست در لایه `UseCase` تعریف شده و مورد استفاده قرار بگیرند**
