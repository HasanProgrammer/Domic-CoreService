...
public class ProducerEventJob : IHostedService, IDisposable
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        var currentServiceJob = $"{ _externalMessageBroker.NameOfService }-{ nameof(ProducerEventJob) }";
        ...
        _timer =
            new Timer(state => {
                ...
                _externalMessageBroker.PublishAsync(cancellationToken);
